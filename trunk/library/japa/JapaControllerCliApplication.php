...
class JapaControllerCliApplication extends JapaController
{
    /**
    ...
    {  
        ...
        include_once( JAPA_LIBRARY_DIR . 'japa/JapaControllerCliPageFactory.php' );
        ...
        try
        {
             ...
             * Set controller type
             */
            $this->config->setVar('controller_type', 'cli', false);   
            ...
            $this->controller = new JapaControllerCliPageFactory;
