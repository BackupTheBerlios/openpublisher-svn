...
newwindow= window.open('<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/nodecoration/1/mod/keyword/cntr/map','',mm); }
</script>
<style type="text/css">
<!--
.optsel {
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/keyword">Top</a>
  <?php foreach($tpl['branch'] as $key): ?>
   / <a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/keyword/id_key/<?php echo $key['id_key']; ?>"><?php echo $key['title']; ?></a>
  <?php endforeach; ?>
  <?php if($tpl['id_key']!=0): ?>
  ...
  <?php if(isset($tpl['keys']) && (count($tpl['keys'])>0)): ?>
    ...
    <?php endif; ?>
        ...
        <td width="1%" align="left" valign="top" class="font9"><?php if($key['lock']==FALSE): ?><a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/keyword/cntr/editKeyword/id_key/<?php echo $key['id_key']; ?>">edit</a><?php endif; ?>&nbsp;</td>
  ...
  <?php endif; ?>
    ...
    <td width="11%" align="center" valign="top" class="font12">
       <a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/keyword/cntr/addKeyword/id_key/<?php echo $tpl['id_key']; ?>">add keyword</a>
