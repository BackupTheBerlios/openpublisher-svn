...
<form accept-charset="<?php echo $view['charset']; ?>" action="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/keyword/cntr/editKeyword" method="post" enctype="multipart/form-data" name="editkeyword" id="editkeyword">
<input name="id_key" type="hidden" value="<?php echo $view['key']['id_key']; ?>">
...
<input name="id_parent" type="hidden" value="<?php echo $view['key']['id_parent']; ?>">
<input name="old_status" type="hidden" value="<?php echo $view['key']['status']; ?>">
<input name="delete_key" type="hidden" value="0">
<table width="100%" border="0" cellspacing="3" cellpadding="3">
  <tr>
    <td class="moduleheader2">Edit Keyword ID: <?php echo $view['key']['id_key']; ?></td>
    </tr>
  <tr>
    ...
    <?php foreach($view['error'] as $err): ?>
      ...
      <tr>
        <td align="left" valign="top" >
         <div class="font12 indent5">
            ...
            <?php foreach($view['branch'] as $nkey): ?>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
              <td align="left" valign="top"><select name="status" size="1" id="status" class="treeselectbox">
                <option value="2" <?php if($view['key']['status'] == 2) echo 'selected="selected"'; ?>>active</option>
                <option value="1" <?php if($view['key']['status'] == 1) echo 'selected="selected"'; ?>>inactive</option>
              </select></td>
              <td align="left" valign="top"><select name="key_id_parent" size="1" id="key_id_parent" class="treeselectbox">
                ...
                <option value="<?php echo $val['id_key']; ?>" <?php if($val['id_key'] == $view['key']['id_parent'] ){ echo 'selected="selected"'; echo 'class="optsel"'; }?>><?php echo str_repeat('-',$val['level'] * 3); echo $val['title']; ?></option>
                <?php endforeach; ?>
              </select></td>
      ...
      <tr>
        <td align="left" valign="top"><input name="title" type="text" id="title" size="90" maxlength="1024" value="<?php echo $view['key']['title']; ?>"></td>
      </tr>
      <tr>
        <td align="left" valign="top" class="font10bold">Description</td>
      </tr>
      <tr>
        <td align="left" valign="top" class="font10bold"><textarea name="description" cols="90" rows="5" id="description"><?php echo $view['key']['description']; ?></textarea></td>
      </tr>
      <tr>
