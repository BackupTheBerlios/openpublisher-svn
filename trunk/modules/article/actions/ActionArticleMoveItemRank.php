 ...
 *
 */
class ActionArticleMoveItemRank extends JapaAction
{                          
    /**
     * 
     *
    ...
    function validate( $data = FALSE )
    {
        ...
        {        
            throw new JapaModelException ('"id_article" must be defined'); 
        } 
        elseif(!is_int($data['id_article'])  )
        {        
            throw new JapaModelException ('"id_article" must be an integer'); 
        } 
