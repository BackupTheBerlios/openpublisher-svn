...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php if($tpl['disableMainMenu']!=TRUE): ?>
     <a href="<?php echo JAPA_CONTROLLER; ?>?mod=article&view=views" class="font10">articles views</a>
  <?php endif; ?> 
  </td>    
    <td width="17%" align="center" valign="middle" class="moduleheader">
  <?php if($tpl['disableMainMenu']!=TRUE): ?>
     <a href="<?php echo JAPA_CONTROLLER; ?>?mod=article&view=summary" class="font10">articles summary</a>
  <?php endif; ?> 
  </td>
    <td width="20%" align="center" class="moduleheader">
  <?php if(($tpl['disableMainMenu']!=TRUE)&&($tpl['show_admin_link']==TRUE)): ?>
     <a href="<?php echo JAPA_CONTROLLER; ?>?mod=article&view=options" class="font10">article module options</a>
  <?php endif; ?>
  </td>
  </tr>
  <tr>
