...
<br />
<form name="form1" method="post" action="<?php echo $view['url_base']; ?>/Module/mod/user/cntr/login">
  ...
  <tr> 
      <td width="26%" valign="top" align="left" class="loginitem">
            Login<br>
            <input type="text" name="login_name" maxlength="1000" size="25" value="<?php echo $view['login_name']; ?>"></td>
  ...
  <tr>
    <td valign="top" align="left" class="loginitem">Turing Key<br>
      ...
      <input type="hidden" name="captcha_public_key" value="<?php echo $view['public_key']; ?>" maxlength="5" size="40"></td>
    <td valign="top" align="center" class="logintext"><span class="logintext"><img src="<?php echo $view['captcha_pic']; ?>" border="1"></span></td>
  </tr>
  <tr align="center"> 
