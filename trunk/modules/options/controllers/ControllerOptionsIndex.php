...
/**
 * ControllerOptionsIndex
 *
 */
 
class ControllerOptionsIndex extends JapaControllerAbstractPage
{
    /**
    ...
    public function perform()
    {
        ...
        $this->viewVar['module_option_controller'] = $this->controllerLoader->$module_controller();  
    }    
    /**
     * get requested module controller name
     *
    ...
    public function getRequestedModuleController()
    {
        ...
        return 'Options' . ucfirst($controller_request);                    
    }
}
