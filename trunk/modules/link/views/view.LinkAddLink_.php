...
<form accept-charset="<?php echo $view['charset']; ?>" name="addnode" method="post" action="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/link/cntr/addLink/id_node/<?php echo $view['id_node']; ?>">
<table width="100%" border="0" cellspacing="3" cellpadding="3">
  ...
  <tr>
    <td width="57%" align="left" valign="top"><table width="400" border="0" cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td align="left" valign="top" class="font10bold"><select name="status">
          <option value="2"<?php if($view['status']==2) echo ' selected="selected"'; ?>>Active</option>
          <option value="1"<?php if($view['status']==1) echo ' selected="selected"'; ?>>Inactive</option>
        </select></td>
      </tr>  	  
      <tr>
      ...
      <tr>
        <td height="29" align="left" valign="top"><input name="url" type="text" id="url" size="90" maxlength="1024" value="<?php echo $view['url']; ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="29" align="left" valign="top"><textarea name="description" cols="80" rows="5" id="description"><?php echo $view['description']; ?></textarea></td>
      </tr>	  
      <tr>
    ...
    <td width="43%" align="left" valign="top" class="font10bold"><a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/link/id_node/<?php echo $view['id_node']; ?>">back</a></td>
  </tr>
</table>
</form>