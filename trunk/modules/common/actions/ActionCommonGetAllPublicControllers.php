...
class ActionCommonGetAllPublicControllers extends JapaAction
{
    ...
    public function perform( $data = FALSE )
    {
        ...
        $controller_dir  = JAPA_APPLICATION_DIR . 'controllers/' . $this->config->getModuleVar('common','views_folder');
        ...
        $view_dir = JAPA_PUBLIC_DIR . 'views/' . $this->config->getModuleVar('common','views_folder');
