 ...
 */
	...
	$cachePath = realpath("../../../../data/common/tinymce_cache"); // Cache path, this is where the .gz files will be stored
	$expiresOffset = 86400; // Cache for 10 days in browser cache
	$content = "";
	$encodings = array();
	$supportsGzip = false;
	$enc = "";
