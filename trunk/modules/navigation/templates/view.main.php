...
newwindow= window.open('<?php echo JAPA_CONTROLLER; ?>?nodecoration=1&mod=navigation&view=nodemap','',mm); }
</script>
<style type="text/css">
<!--
.optsel {
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation">Top</a>
  <?php foreach($tpl['branch'] as $node): ?>
   / <a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation&id_node=<?php echo $node['id_node']; ?>"><?php echo $node['title']; ?></a>
  <?php endforeach; ?>
  ...
  <?php if(isset($tpl['nodes']) && (count($tpl['nodes'])>0)): ?>
    ...
    <?php endif; ?>
        ...
        <td width="21" align="left" valign="top" class="itemnormal"><a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation&id_node_up=<?php echo $node['id_node']; ?>&id_node=<?php echo $node['id_parent']; ?>" title="Move this node up"><img src="./modules/common/media/pics/up.png" width="21" height="21" border="0"></a></td>
        <td width="21" align="left" valign="top" class="itemnormal"><a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation&id_node_down=<?php echo $node['id_node']; ?>&id_node=<?php echo $node['id_parent']; ?>" title="Move this node down"><img src="./modules/common/media/pics/down.png" width="21" height="21" border="0"></a></td>
        <td width="1%" align="left" valign="top" class="font9"><?php if($node['lock']==FALSE): ?><a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation&view=editNode&id_node=<?php echo $node['id_node']; ?>&disableMainMenu=1">edit</a><?php endif; ?>&nbsp;</td>
          <td width="99%" align="left" valign="top" class="itemnormal">
          <?php if($node['lock']==FALSE): ?>
                <?php echo '<a href="'.JAPA_CONTROLLER.'?mod=navigation&id_node='.$node['id_node'].'">'.$node['title'].'</a>'; ?>
  ...
  <?php endif; ?>
    ...
    <td width="11%" align="center" valign="top" class="font12">
       <a href="<?php echo JAPA_CONTROLLER; ?>?mod=navigation&view=addNode&id_node=<?php echo $tpl['id_node']; ?>">add node</a>
