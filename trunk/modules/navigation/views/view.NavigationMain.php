...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <?php if(isset($tpl['nodes']) && (count($tpl['nodes'])>0)): ?>
    ...
    <?php endif; ?>
        ...
        <td width="1%" align="left" valign="top" class="font9"><?php if($node['lock']==FALSE): ?><a href="<?php echo $view['url_base']; ?>/<?php echo $view['adminWebController']; ?>/mod/navigation/cntr/editNode/id_node/<?php echo $node['id_node']; ?>/disableMainMenu/1">edit</a><?php endif; ?>&nbsp;</td>
